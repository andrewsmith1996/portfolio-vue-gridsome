<template>
 <div class="project__simple">
    ...
    <div class="project__simple-screenshots">
        <g-image src="~/assets/images/apps/hackbusters.png" background="transparent" fit="contain" width="480" height="347" class="project__simple-screenshot" alt="Socket.IO, Node.js and Express interactive Dambusters Game" />
    </div>
  </div>
</template>
