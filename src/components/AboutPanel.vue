...
<section class="about-panel">
  <div class="about-panel__block">
    <g-image class="about-panel__block-icon" src="~/assets/images/icons/web.png" alt="Web Development Icon" />
  ...
  <div class="about-panel__block">
    <g-image class="about-panel__block-icon" src="~/assets/images/icons/mobile.png" alt="Mobile Development Icon" />
  ...
  <div class="about-panel__block">
    <g-image class="about-panel__block-icon" src="~/assets/images/icons/comp-sci.png" alt="Computer Science Icon" />
